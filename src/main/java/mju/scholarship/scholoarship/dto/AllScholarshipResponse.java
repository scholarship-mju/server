...
public class AllScholarshipResponse {
    ...
    @Builder
    public AllScholarshipResponse(Long id, String name, String organizationName, String scholarshipImage, String supportDetails, Boolean isInterested, ScholarshipProgressStatus progressStatus, int viewCount) {
        this.id = id;
        this.name = name;
